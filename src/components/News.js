...
export default class News extends Component {
    ...
    async componentDidMount() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=93d63f63dff442e2a78f08410b46cd2c&pageSize=${this.props.pageSize}`;
    ...
    handlePreviousClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=93d63f63dff442e2a78f08410b46cd2c&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`//"https://newsapi.org/v2/top-headlines?country=in&apiKey=93d63f63dff442e2a78f08410b46cd2c";
        let data = await fetch(url);
        let parseData = await data.json();
        // console.log(parseData);
        this.setState({
